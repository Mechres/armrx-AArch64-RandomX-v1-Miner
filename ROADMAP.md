...
| [`docs/plans/future-performance-ideas-20260725.md`](docs/plans/future-performance-ideas-20260725.md) | Speculative, unscheduled future performance ideas — where the evidence points if performance work resumes |
| [`docs/experiments/branchless-cbranch.md`](docs/experiments/branchless-cbranch.md) | CBRANCH misprediction analysis, imm19 bug root cause, BTB aliasing caveat |
