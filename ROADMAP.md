...
### Next Up
1. **T2-2** — dual-issue alignment (needs JIT-file gate lifted)
2. T3 items — design-first, gated (Track C retry blocked on diagnostic)
